function About() {
  return (
    ...
    <div className="text-center">
      ...
      <div className="text-base text-blue-700 my-1">Chief Technology Officer</div>
    ...
    <div className="flex flex-col my-12 items-center">
     <div className="w-32 h-32 mb-4">
      ...
      <div className="text-base text-blue-700 my-1">Chief Executive Officer</div>
      <div className="text-base text-center my-1">
    ...
    <div className="container mx-auto p-4 text-center">
      <div className="text-blue-600 text-lg mb-4 font-bold">About Us</div>
      <h1 className="text-3xl font-bold mb-4">Making Sure Your Crypto is Always Yours</h1>
